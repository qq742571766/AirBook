...
public class CarAdapter extends FakeSearchAdapter<VehDataBean> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.carModels.setText(getItem(position).getVehnumbers());
        return convertView;
    }

    static class ViewHolder {
        private final TextView carModel;
        private final TextView carModels;
        ViewHolder(View convertView) {
            carModel = (TextView) convertView.findViewById(R.id.car_model);
            carModels = (TextView) convertView.findViewById(R.id.car_models);
        }
    }
}
