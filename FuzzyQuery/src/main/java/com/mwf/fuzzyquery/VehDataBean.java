...
public class VehDataBean implements Parcelable, SearchItem {
    ...
    private String vehnumbers;

    public VehDataBean(String vehnumber, String vehnumbers) {
        this.vehnumber = vehnumber;
        this.vehnumbers = vehnumbers;
    }

    protected VehDataBean(Parcel in) {
        vehnumber = in.readString();
        vehnumbers = in.readString();
    }
